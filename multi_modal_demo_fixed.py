...
if __name__ == "__main__":
    ...
    # Fiction template content
    fiction_template = '''# Untitled Fiction
...
[Your story begins here...]'''
    ...
    # Screenwriting template content
    screenplay_template = '''Title: UNTITLED SCREENPLAY
Credit: Written by
Author: Your Name
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="editor-container">
                ...
                <div class="editor" id="editor">{python_template}</div>
            </div>
        </div>
    ...
    <script>
        ...
        const modeData = [
            {{
                ...
                editorContent: `{fiction_template}`
            }},
            {{
                name: "Screenwriting",
                ...
                editorContent: `{screenplay_template}`
            }},
            {{
                name: "Code",
